...
class DescriptiveFormSlider extends StatefulWidget {
  final String label;
  ...
  @override
  State<DescriptiveFormSlider> createState() => _DescriptiveFormSliderState();
}

class _DescriptiveFormSliderState extends State<DescriptiveFormSlider> {
  double _value = 0;
  ...
  @override
  void didUpdateWidget(DescriptiveFormSlider oldWidget) {
